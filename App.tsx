          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center bg-white/50 dark:bg-white/[0.02] p-4 rounded-3xl border border-gray-300 dark:border-white/10">
              <button 
                ...
                className="px-6 py-2 bg-gray-200 dark:bg-white/5 rounded-xl text-[10px] font-black uppercase tracking-widest"
              >
                ← Voltar aos Simulados
              </button>
              <div className="px-6 py-2 text-primary text-[10px] font-black uppercase flex items-center gap-2">
                <Shield className="w-4 h-4" /> Operação Simulado
              </div>
            </div>
            <QuestionViewer questions={displayedQuestions} onAnswer={addAttempt} title="Simulado Oficial" />
          </div>
        );
      }
